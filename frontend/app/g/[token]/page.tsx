  ...
  if (error) return (
    <div className="min-h-screen bg-white flex items-center justify-center p-8">
      <div className="text-center">
        <div className="w-16 h-16 bg-[#EDE8D0] border border-[#e8e5e0] rounded-2xl flex items-center justify-center mx-auto mb-6">
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-8 py-6 border-b border-[#e8e5e0]">
        ...
        {scanResult !== null && (
          <div className="mt-4">
            {scanResult.length === 0 ? (
              <div className="bg-[#EDE8D0] border border-[#e8e5e0] rounded-xl px-4 py-3 text-[#888] text-sm">
